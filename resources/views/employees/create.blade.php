        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group @if($errors->has('code')) has-error @endif">
                    ...
                    <input type="text" id="code-field" name="code" class="form-control" value="s{{ $employee_id }}" readonly/>
                       @if($errors->has("code"))
                    ...
                    <div class="form-group @if($errors->has('date_of_brith')) has-error @endif">
                       <label for="date_of_brith-field">Date of birth</label>
                    <input type="text" id="date_of_brith-field" name="date_of_brith" class="form-control date-picker" value="{{ old("date_of_brith") }}"/>
                    ...
                    <input type="text" id="date_of_joining-field" name="date_of_joining" class="form-control date-picker" value="{{ old("date_of_joining") }}"/>
                    ...
                    <input type="number" id="salary_amount-field" min="0" name="salary_amount" class="form-control" value="{{ old("salary_amount") }}"/>
                    ...
                    <input type="number" id="basic_pay-field" min="0" name="basic_pay" class="form-control" value="{{ old("basic_pay") }}" readonly/>
                    ...
                    <input type="number" id="hra-field" min="0" name="hra" class="form-control" value="{{ old("hra") }}" readonly/>
                       @if($errors->has("hra"))
                    ...
                    <div class="form-group @if($errors->has('washing_allowance')) has-error @endif">
                        ...
                        <input type="number" id="washing_allowance-field" min="0" name="washing_allowance" class="form-control" value="{{ old("washing_allowance") }}" readonly/>
                    ...
                    <input type="text" id="pf_number-field" name="pf_number" class="form-control" value="{{ old("pf_number") }}"/>
                    ...
                    <input type="text" id="esi_number-field" name="esi_number" class="form-control" value="{{ old("esi_number") }}"/>
                    ...
                    <div class="form-group @if($errors->has('bank_account_no')) has-error @endif">
                      ...
                      <input type="text" id="bank_account_no-field" name="bank_account_no" class="form-control" value="{{ old("bank_account_no") }}"/>
                    ...
                    <div class="form-group @if($errors->has('address')) has-error @endif">
                      ...
                      <textarea id="address-field" name="address" class="form-control">{{ old("address") }}</textarea>
                    ...
                    <div class="btn-group" data-toggle="buttons"><label class="btn btn-primary"><input type="radio" value="1" name="status" id="status-field" autocomplete="off"> Active</label><label class="btn btn-primary active"><input type="radio" name="status" value="0" id="status-field" autocomplete="off"> Inactive</label></div>
